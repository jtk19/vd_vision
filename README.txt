...
Most of the important directories and definitions are defined in this "config.h" file.  So 
...
#  apt update -y  
#  apt upgrade -y  
#  apt install -y git libgtk2.0-dev pkg-config libavcodec-dev libavformat-dev libswscale-dev python-dev python-numpy python3-dev python3-numpy python-scipy python3-scipy libtbb2 libtbb-dev libjpeg-dev libpng-dev libtiff-dev libdc1394-22-dev libeigen2-dev libeigen3-dev "ffmpeg*" "gstreamer*" g++-7 cmake  
#   
#  exit  
